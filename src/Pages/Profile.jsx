        ...
        setUser({
          ...
          image:
            data.user_image && data.user_image !== "" 
              ? data.user_image 
              : `https://ui-avatars.com/api/?name=${encodeURIComponent(initials)}&background=4F46E5&color=fff&size=128&bold=true`,
        });
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md overflow-hidden sticky top-27">
                <div className="bg-gradient-to-r from-blue-200 to-blue-300 p-6 text-center">
                  <div className="relative inline-block">
                    <img 
                      src={user.image}
                      alt={user.name} 
                      className="w-30 h-30 rounded-full border-4 border-white shadow-lg mx-auto object-cover" 
                    />
                    <button 
                ...
                <div className="p-3 space-y-1">
                  ...
                  <button 
                    onClick={logout}
                    className="w-full flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 font-medium py-3 rounded-lg transition-all"
                  > 
